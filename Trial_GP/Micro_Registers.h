...
#define MSG_BUFF_PARAM		(*((volatile unsigned long *)0x00000270))
#define MSG_BUFF_ID 		(*((volatile unsigned long *)0x00000274))
#define MSG_BUFF_DATA_0		(*((volatile unsigned long *)0x00000278))
#define MSG_BUFF_DATA_4		(*((volatile unsigned long *)0x0000027C)) // page 1781 to be asked absolute or offset
