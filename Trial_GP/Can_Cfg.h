...
#define CanChangeBaudrateApi 			STD_OFF
#define CAN_DEV_ERROR_DETECT 			STD_OFF
#define CanHardwareCancellation 		STD_OFF
#define CanIdenticalIdCancellation 		STD_OFF
#define CanIndex 						(uint8)0x00
#define CanLPduReceiveCalloutFunction	toBeNamed		// TO BE CHANGED
#define CanMainFunctionBusoffPeriod		(float32)0.001  // TO BE CHANGED
#define CanMainFunctionModePeriod		(float32)0.001
#define CanMainFunctionWakeupPeriod		(float32)0.001
#define CanMultiplexedTransmission		STD_OFF
#define CanTimeoutDuration				(float32)0.001
#define CAN_VERSION_INFO_API			STD_ON
#define CanCounterRef					OsCounter 		// TO BE CHANGED
#define CanSupportTTCANRef				CanIfPrivateCfg // TO BE CHANGED
...
#define CanControllerBaseAddress		// DON'T KNOW WHAT THIS IS
#define CanControllerId					(uint8)0x00
#define CanRxProcessing					POLLING
#define CanTxProcessing					POLLING
#define CanWakeupProcessing				POLLING
#define CanWakeupSupport				STD_OFF
#define CanControllerDefaultBaudrate	CanControllerBaudrateConfig		// TO BE CHANGED
#define CanCpuClockRef					McuClockReferencePoint			// TO BE CHANGED
#define CanWakeupSourceRef				EcuMWakeupSource				// TO BE CHANGED
...
#define CanFilterMaskValue				(uint16)100

/*******************************************************************************
 *             			CanMainFunctionRWPeriods               	               *
 *******************************************************************************/

#define CanMainFunctionReadPeriod		(float32)0.001
#define CanMainFunctionWritePeriod		(float32)0.001
