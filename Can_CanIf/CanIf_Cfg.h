...
#define CanIfTxPduUserTriggerTransmitName	PduR_TriggerTransmit	// To be removed
#define CanIfTxPduUserTxConfirmationName	PduR_TxConfirmation		// To be checked
...
#define CanIfRxPduUserRxIndicationName		PduR_RxIndication
#define CanIfRxPduUserRxIndicationUL		PDUR

/* EXTERN FROM CAN DRIVER CONFIG */
extern const CanController canController;
extern const CanHardwareObject canHardwareReceiveObject;
extern const CanHardwareObject canHardwareTransmitObject;
extern const Can_HwType ReceiveMailbox;
